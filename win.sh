...
case "$PILIHOS" in
	1|"") PILIHOS="http://drive.muavps.net/windows/Windows2022.gz";;
	2) PILIHOS="http://drive.muavps.net/windows/Windows2022.gz";;
	3) PILIHOS="http://drive.muavps.net/windows/Windows2022.gz";;
